<footer id="colophon" class="s-footer">
    ...
    <div class="row s-footer__main">
        ...
        <div class="column lg-5 md-6 tab-12 s-footer__about">
            <h4>About Me</h4>
            <p>Hello, I'm <b>Aljon Lerios</b>. A passionate laravel developer based in Baybay City, Philippines.</p>
            ...
            <div class="row">
                <div class="column lg-6">
                    ...
                    <ul class="link-list">
                        ...
                        <li><a href="category.html">Blade</a></li>
                        <li><a href="about.html">Javascript</a></li>
                    </ul>
                </div>
                <div class="column lg-6">
                    <h4>Categories</h4>
    ...
    <div class="row s-footer__bottom">
        ...
        <div class="column lg-7 md-6 tab-12">
            <ul class="s-footer__social">
                <li>
                    <a href="https://www.facebook.com/iamjuney1412/">
